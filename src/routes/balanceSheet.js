...
router.get('/', async (req, res) => {
  try {
    ...
    // Second query — calculate net income from revenue and expenses
    ...
    const totalLiabilitiesAndEquity = liabilitiesAndEquity.reduce((sum, a) => sum + a.balance, 0);

    // Net income is added to equity side to complete the equation
